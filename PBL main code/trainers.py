...
class vaeTrainer(BaseTrain):
    ...
    def val_step(self):
        ...
        val_cost, recon_loss_val, kl_loss_val, std_dev_loss_val = self.sess.run([self.model.elbo_loss,
                                                                                 self.model.is_reconstruction_error,
                                                                                 self.model.KL_loss,
    ...
    def test_step(self):
        ...
        self.output_test, test_loss, test_recons_loss_weighted, test_kl, test_sigma_regularisor, test_code_std_norm, test_cur_sigma2, test_recons_loss_ls = self.sess.run(
            [self.model.decoded,
             ...
             self.model.weighted_recostruction_error_dataset,
             self.model.KL_loss,
        ...
        return test_loss, test_recons_loss_weighted, test_kl, test_sigma_regularisor, test_code_std_norm, np.squeeze(test_cur_sigma2), test_recons_loss_ls
